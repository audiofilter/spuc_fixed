// Basic Test program for fp_int type
#include <iostream>
#include <fstream>
#include <iomanip>
#include <cmath>
...
int main(int argc, char* argv[]) {
  ...
  spuc_int<INT_BITS> x;
  spuc_int<INT_BITS> y;
  spuc_int<INT_BITS> diff;
  spuc_int<INT_BITS> ls;
  spuc_int<INT_BITS> rs;
  ...
  double eq_val = diff;
  spuc_int<INT_BITS> x3 = 3;
  spuc_int<INT_BITS> y5 = 5;
  spuc_int<INT_BITS-1> w3 = 3;
  spuc_int<INT_BITS-1> z5 = 5;

  // comparisions with double/int
  COMPARES( diff, 5, 3, double);
  COMPARES( diff, 5, 3, int);
  COMPARES( diff, y5, x3, spuc_int<INT_BITS>);
  COMPARES( diff, z5, w3, spuc_int<INT_BITS-1>);
  ...
  spuc_int<INT_BITS> t_one = 1;
  spuc_int<INT_BITS> one = 1;
  spuc_int<INT_BITS> two = 2;
  spuc_int<INT_BITS> minus10 = -10;
